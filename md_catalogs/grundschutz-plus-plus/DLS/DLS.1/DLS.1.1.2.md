...
# DLS.1.1.2 - \[Grundlagen\] Zuweisung der Aufgaben

## Control Statement

Dienstleistersteuerung für Dienstleistungen MUSS die mit den Verfahren und Regelungen verbundenen Aufgaben {{ insert: param, dls.1.1.2-prm1 }} zuweisen.
